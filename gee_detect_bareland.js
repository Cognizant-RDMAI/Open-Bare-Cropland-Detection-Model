...
var studyArea = ee.FeatureCollection('projects/rdmai-dev-ee/assets/farmlands_browney');

// Load a dataset that contains information about different crop types in the same area
var cropArea = ee.FeatureCollection('projects/rdmai-dev-ee/assets/farmlands_croptype_browney');
